...
variable "environment" {
  ...
  validation {
    condition     = contains(["demo", "dev", "ithc", "mgmt", "ptl", "ptlsbox", "prod", "sbox", "stg", "test", "sit"], var.environment)
    error_message = "Valid values for environment are (demo, dev, ithc, mgmt, ptl, ptlsbox, prod, sbox, stg, test, sit)."
  }
}
